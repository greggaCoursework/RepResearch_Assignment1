...
```{r spd, echo=FALSE, fig.cap="Historgram of Steps per Day", out.width = '100%'}
...
```{r spi, echo=FALSE, fig.cap="Daily Activity Pattern", out.width = '100%'}
...
```{r tspd, echo=FALSE, fig.cap="Steps per Day", out.width = '100%'}
...
sessioninfo()
```{r 5min, echo=FALSE, fig.cap="Weekend versus Weekday Steps", out.width = '100%'}
